...
const Skills = (props: Props) => {
  return (
    <motion.div
      ...
      <h3 className="absolute top-24 uppercase tracking-[20px] text-gray-500 dark:text-gray-900 text-2xl ">
        Skills
      </h3>
      <h3 className="absolute top-[8.5rem] uppercase tracking-[3px] text-gray-500 dark:text-gray-900 text-sm">
